...
export default function Signup() {
    ...
    const signupApi = async (e) => {
        ...
        try {
            ...
            if (jsonRes.already_exists) {
                gsap.to("#signupIndicator", { marginTop: 0 })
                ...
                setSignupLoading(false);
                setSignupBTN(true)
                gsap.to("#signupIndicator", { marginTop: "-28px" })
            ...
            <div className="flex justify-center items-center h-screen">
                <div className="w-80 bg-white p-8 rounded-lg shadow-lg">
                    ...
                    <form className="mb-4" onSubmit={signupApi}>
                        ...
                        />
                        <p id='signupIndicator' className='text-sm text-blue-700 mb-2 ml-1 mt-[-28px]'>This acount already exist</p>
                        {
                            signupBTN &&
                            <button
