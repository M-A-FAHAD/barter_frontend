...
export default function Searchbar() {
    return (
        <div className=" p-8 flex justify-center items-center w-full bg-gray-200 ">
            <div className="w-[50%] sm:w-[80%] h-10 flex overflow-hidden rounded-full">
                <input className="h-full w-[90%] sm:w-[85%] pl-4 focus:outline-none " type="text" name="search" placeholder="Search you products" />
